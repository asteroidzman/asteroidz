...
Found 2026-08-20 by a render-matrix fixture that had never been run: it sat
outside the suite register's discovery glob until that was widened. Both the
fixture and the register have since been removed.
